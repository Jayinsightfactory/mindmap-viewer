...
while ($true) {
  ...
  router.get('/install-clean.bat', async (req, res) => {
    ...
    const batContent = [
      ...
      '',
      'REM --- 다운로드 우선순위: curl -> PowerShell ---',
      'REM --- bitsadmin 제거 (deprecated, 일부 환경 무응답 종료 사고) ---',
      'echo   다운로드 시도 1/2: curl (Windows 10/11 내장)...',
      ...
      ')',
      '',
      'echo   curl 실패. 다운로드 시도 2/2: PowerShell...',
      ...
      '    echo.',
      '    echo   ====================================================',
      '    echo   [성공] 설치 완료 - 데이터 수집 시작',
      '    echo   ====================================================',
      '    echo.',
      ')',
      '',
      'REM --- 로그 파일 출력 (성공/실패 모두) ---',
      'echo.',
      ...
      'echo   서버: %ORBIT_REMOTE%',
      'echo   전체 로그: %USERPROFILE%\\.orbit\\clean-install.log',
      'echo   데몬 로그: %USERPROFILE%\\.orbit\\daemon.log',
      'echo   ====================================================',
      'echo.',
      'echo   창을 직접 닫으려면 아무 키나 누르세요...',
      'pause >nul',
