# ═══════════════════════════════════════════════════════════════════════════
# Orbit AI — Clean Install (v11 = v9 베이스 복원, AMSI 친화)
# ═══════════════════════════════════════════════════════════════════════════
# v10 의심 패턴 5종 제거 (정확한 키워드는 보안상 미기재):
#   - .NET 인라인 컴파일 / 다른 ps1 패턴매칭 / 파일핸들 락검증 /
#     특정 호스트 프로세스 종료 / Defender 예외 직접 호출
# 데몬측 코드 정리(win-shell 안정화)로 위 패턴 모두 불필요해짐
#
# 원칙 (v9 그대로 유지):
