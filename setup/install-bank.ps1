...
$BANK_MODE = $true
$SCRIPT_URL = "$REMOTE/setup/install-bank.ps1"
...
Write-Host ""
Write-Host "  [은행앱 모드] 은행 보안 프로그램 실행 중에는" -ForegroundColor Yellow
Write-Host "  캡처/수집이 자동으로 일시정지됩니다." -ForegroundColor Yellow
Write-Host ""
try {
