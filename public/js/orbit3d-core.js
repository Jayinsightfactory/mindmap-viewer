...
// 스크린 좌표 → 해당 위치 줌인 + 팬 (세션 클릭 시 사용)
window.zoomToScreenPos = function(screenX, screenY, targetScale, duration) {
  const canvas = typeof _labelCanvas2d !== 'undefined' ? _labelCanvas2d : null;
...
class OrbitCam {
  constructor(cam, el) {
    ...
    this.sph = { r:20, θ:0.3, φ:1.1 };                  // 컴팩트 뷰 기본 거리
