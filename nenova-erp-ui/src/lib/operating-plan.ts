...
export const OPS_MODULES: OpsModule[] = [
  ...
  },
  {
    ...
    title: "카카오톡/워크 업무 게이트",
    status: "설계",
    owner: "전 직원",
    summary: "카카오톡/워크 메시지, 답장, 승인 액션을 업무 이벤트로 받아 주문, 견적, 프로젝트, 할 일로 연결합니다.",
    inputs: ["카카오톡/워크 메시지", "사용자 ID", "대화방 ID", "버튼/답장 액션"],
    outputs: ["업무 이벤트", "담당자 알림", "AI 분류", "상태 업데이트"],
  },
  {
    id: "work-unit-validation",
    title: "직원 작업 단위 교차검증",
    status: "구축",
    owner: "운영",
    summary: "직원 계정별 업무영역을 기준으로 클릭 시간, PC 화면, 카카오톡 대화, ERP 상태를 맞춰 실제 작업 단위를 확인합니다.",
    inputs: ["nenova.exe 작업", "클릭/윈도우 타이틀", "카카오톡/워크 대화", "ERP 고객/프로젝트/할 일"],
    outputs: ["작업 단위", "대화↔작업 관계", "3차 검증 상태", "자동화 후보"],
  },
  {
    id: "contacts",
    title: "명함-연락처 OCR",
...
- 직원 작업 단위는 계정별 업무영역, 클릭 시간대, 카카오톡/워크 대화, PC 화면/앱, ERP 상태를 3차 교차검증한다.
`;
...
export const PROMPT_TEMPLATES = [
  ...
  "직원 계정별 작업 단위와 카카오톡 대화가 어떻게 이어졌는지 검증해줘.",
];
